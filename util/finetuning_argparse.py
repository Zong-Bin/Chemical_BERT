...
def get_argparse():
    ...
    # Required parameters
    # 任务cner和cluener，需要更改参数为task_name，data_dir
    parser.add_argument("--task_name", default = 'zyner', type = str,
                        help = "The name of the task to train selected in the list: ")
    # 数据集路径
    parser.add_argument("--data_dir", default = r'E:\日常\实习\ner_v3\datasets\zhongyi', type = str, help = "The input data dir. Should contain the training files for the CoNLL-2003 NER task.", )
    parser.add_argument("--dev_dir", default = r'E:\日常\实习\ner_v3\datasets\zhongyi', type = str, help = "The input data dir. Should contain the training files for the CoNLL-2003 NER task.", )
    parser.add_argument("--test_dir", default = r'E:\日常\实习\ner_v3\datasets\cner', type = str, help = "The input data dir. Should contain the training files for the CoNLL-2003 NER task.", )

    # 模型类型
    # albert需更改model_name_or_path和config_name, model_type
    ...
    parser.add_argument("--model_name_or_path", default = 'bert-base-chinese', type = str,
                        help = "Path to pre-trained model or shortcut name selected in the list: ['bert-base-chinese', 'voidful/albert_chinese_large']")
    parser.add_argument("--config_name", default = "bert-base-chinese", type = str,
                        help = "Pretrained config name or path if not the same as model_name")

    # 输出路径
    parser.add_argument("--output_dir", default = r'E:\日常\实习\ner_v3\outputs', type = str,
    ...
    parser.add_argument("--do_adv", default = True, action = "store_true",
